...
The current OpenPPG SP140 Controller is based on the ESP32 platform and uses the Web Serial API to communicate from your browser to your device. See [supported desktop browsers](https://caniuse.com/web-serial).
